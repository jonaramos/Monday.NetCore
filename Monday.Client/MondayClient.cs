...
namespace Monday.Client
{
    ...
    public class MondayClient
    {
        ...
        {
            GraphQlHttpClient = new GraphQLHttpClient("https://api.monday.com/v2/", new NewtonsoftJsonSerializer());
        ...
        public async Task<bool> ArchiveBoard(string boardId)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<dynamic>(request);
        ...
        public async Task<string> CreateBoard(CreateBoard createBoard)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<CreateBoardResponse>(request);
        ...
        public async Task<string> CreateColumn(CreateColumn createColumn)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<CreateColumnResponse>(request);
        ...
        public async Task<string> CreateGroup(CreateGroup createGroup)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<CreateGroupResponse>(request);
        ...
        /// <returns></returns>
        public async Task<string> CreateItem(CreateItem createItem)
        {
            var request = new GraphQLRequest
            {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<CreateItemResponse>(request);
        ...
        public async Task<int> CreateTag(CreateTag createTag)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<CreateTagResponse>(request);
        ...
        public async Task<string> CreateUpdate(CreateUpdate createUpdate)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<CreateUpdateResponse>(request);
        ...
        public async Task<T> CustomQueryOrMutation<T>(string queryOrMutation, object variables)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<T>(request);
        ...
        public async Task<Board> GetBoard(string boardId)
        {
            ...
            var result = await GraphQlHttpClient.SendQueryAsync<GetBoardsResponse>(request);
        ...
        public async Task<Complexity> GetComplexity(string query)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<GetComplexityResponse>(request);
        ...
        public async Task<List<Group>> GetGroups(string boardId)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<GetGroupsResponse>(request);
        ...
        public async Task<Item> GetItem(string itemId)
        {
            ...
            var result = await GraphQlHttpClient.SendQueryAsync<GetItemsResponse>(request);
        ...
        public async Task<List<Item>> GetItems(string boardId)
        {
            var request = new GraphQLRequest
            {
                Query = @"query request($id:ID!) { boards(ids:[$id]) { items(limit: 100000) { id name board { id name description board_kind } group { id title archived deleted } creator_id created_at updated_at creator { id name email } } } } ",
                Variables = new
                {
                    id = boardId
                }
            ...
            var result = await GraphQlHttpClient.SendQueryAsync<GetBoardItemsResponse>(request);
        ...
        public async Task<Tag> GetTag(int tagId)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<GetTagsResponse>(request);
        ...
        public async Task<List<Tag>> GetTags(string boardId)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<GetBoardTagsResponse>(request);
        ...
        public async Task<Team> GetTeam(int teamId)
        {
            ...
            var result = await GraphQlHttpClient.SendMutationAsync<GetTeamsResponse>(request);
        ...
        public async Task<User> GetUser(int userId)
        {
            ...
            var result = await GraphQlHttpClient.SendQueryAsync<GetUsersResponse>(request);
